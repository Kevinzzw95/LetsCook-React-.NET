        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageInfo = table.Column<Dictionary<string, string>>(type: "hstore", nullable: true),
                    ...
                    Diets = table.Column<List<string>>(type: "text[]", nullable: true),
                    DishType = table.Column<string>(type: "text", nullable: true),
                    Summary = table.Column<string>(type: "text", nullable: true),
                    ExtendedIngredients = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Step", x => new { x.InstructionId, x.Id });
                    table.ForeignKey(
